...
/**
 * Created by alex on 2017/7/4.
 */


public class fancyObjSaveUtil {

    private final static String FILENAME = "fancy_local_data_save";

    private static String defaultKey = "loginResult";
